...
export default class Sfx extends Scale {
  ...
  correct() {
    ...
    playPitch(this.context, this.hiThree, 0.05, 0.8);
    ...
    playPitch(this.context, this.hiThree, 0.49, 0.8);
    playPitch(this.context, this.one, 0.66, 0.65);
  }
  wrong() {
    playPitch(this.context, this.hiSix, 0, 0.5);
    playPitch(this.context, this.hiThree, 0.05, 0.5);
  ...
  wrongAlt() {
    playPitch(this.context, this.bHiThree, 0, 0.8);
    playPitch(this.context, this.one, 0.05, 0.8)
  }
}